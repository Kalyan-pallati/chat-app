            ...
            <div className="bg-slate-800 p-8 rounded-lg shadow-xl w-80 border border-slate-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text"
                        className="w-full p-2 rounded bg-slate-700 border border-slate-6600 focus:border-emerald-500 focus:outline-none transition-colors"
                        required
                        value={username}
                    ...
                    {/* As both login and sign up live in single page/route, show this only when login is selected */}
                    {!isLogin && (
                        <div>
                ...
                <div className="mt-6 text-center text-sm text-slate-400">
                    ...
                    className="pl-1 text-emerald-400 hober:text-emerald-300 hover:underline font-medium cursor-pointer"
